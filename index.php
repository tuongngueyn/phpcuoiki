...
<div class="page-wrapper">
                    ...
                    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <a href="product.php">
                                    <img src="assets/images/samsung/galaxy-z-fold-5-kem-1 (1).webp" alt="Product image" class="product-image">
                                </a>
                                ...
                                <div class="product-action product-action-dark">
                                    <a href="#" class="btn-product btn-cart add-to-cart" title="Add to cart" data-id="2" data-title="Samsung Galaxy Z Fold 5" data-image="assets/images/samsung/galaxy-z-fold-5-kem-1.webp" data-price="899.00"><span>add to cart</span></a>
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                ...
                                <a href="productAppleWatchUltra.php">
                                ...
                                <div class="product-action product-action-dark">
                                    <a href="#" class="btn-product btn-cart add-to-cart" title="Add to cart" data-id="3" data-title="Apple Watch Ultra" data-image="assets/images/smartwatch/apple-watch-ultra-2-49mm-4g_1_.jpg" data-price="999.00"><span>add to cart</span></a>
                                    <a href="popup/quickView.php" class="btn-product btn-quickview" title="Quick view"><span>quick view</span></a>
                                </div><!-- End .product-action -->
                            </figure><!-- End .product-media -->
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="productAppleWatchUltra.php">Apple Watch Ultra</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $999.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                ...
                                <div class="product-action product-action-dark">
                                    <a href="#" class="btn-product btn-cart add-to-cart" title="Add to cart" data-id="5" data-title="iPhone 15 Pro Max" data-image="assets/images/iPhone/iphone15blue.webp" data-price="990.00"><span>add to cart</span></a>
                                    <a href="popup/quickView.php" class="btn-product btn-quickview" title="Quick view"><span>quick view</span></a>
                                </div><!-- End .product-action -->
                            </figure><!-- End .product-media -->
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="productIphone15.php">Apple iPhone 15 Pro Max</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $999.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <a href="productMacbookPro14.php">
                                ...
                                <div class="product-action product-action-dark">
                                    <a href="#" class="btn-product btn-cart add-to-cart" title="Add to cart" data-id="6" data-title="Macbook Pro 14 Inch" data-image="assets/images/laptop/macbook-pro-2021-06_8.webp" data-price="999.00"><span>add to cart</span></a>
                                    <a href="popup/quickView.php" class="btn-product btn-quickview" title="Quick view"><span>quick view</span></a>
                                </div><!-- End .product-action -->
                            </figure><!-- End .product-media -->
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="productMacbookPro14.php">Macbook Pro 14 Inch</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $999.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
        ...
        <div class="container trending">
            ...
            <div class="row">
                <div class="col-xl-5col d-none d-xl-block">
                    <div class="banner">
                        <a href="#">
                            <img src="assets/images/demos/demo-3/banners/banner-4.png" alt="banner">
                        </a>
                    </div><!-- End .banner -->
                </div><!-- End .col-xl-5col -->
                            ...
                            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                ...
                                <div class="product product-2">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="productMacbookPro14.php">MacBook Pro 14 2021</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $1,199.99
                                        </div><!-- End .product-price -->
                                        <div class="ratings-container">
                            ...
                            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <span class="product-label label-circle label-top">Top</span>
                                        <a href="product.php">
                                            <img src="assets/images/iPhone/iphone-15-pro-max_3.webp" alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="productIphone15.php">iPhone 15 Pro Max</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $1,199.99
                                        </div><!-- End .product-price -->
                                        <div class="ratings-container">
                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="product.php">
                                            <img src="assets/images/iPhone/iphone-11.webp" alt="Product image" class="product-image">
                                        </a>
                                        ...
                                        <div class="product-action product-action-dark">
                                            <a href="#" class="btn-product btn-cart add-to-cart" title="Add to cart" data-id="1" data-title="iPhone 11" data-image="assets/images/iPhone/iphone-11.webp" data-price="300.00"><span>add to cart</span></a>
                                            <a href="popup/quickView.php" class="btn-product btn-quickview" title="Quick view"><span>quick view</span></a>
                                        </div><!-- End .product-action -->
                                    </figure><!-- End .product-media -->
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.php">iPhone 11</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $300.00
                                        </div><!-- End .product-price -->
                                        <div class="ratings-container">
                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <span class="product-label label-circle label-new">New</span>
                                        <a href="product.php">
                                            <img src="assets/images/iPhone/nothing-phone-2.webp" alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.php">Nothing Phone 2</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            Comming Soon
                                        </div><!-- End .product-price -->
                                        <div class="ratings-container">
                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <span class="product-label label-circle label-top">Top</span>
                                        <a href="product.php">
                                            <img src="assets/images/samsung/samsung-galaxy-z-flip5-kem-4.webp" alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.php">Samsung Galaxy Z Flip 5</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $899.99
                                        </div><!-- End .product-price -->
                                        <div class="ratings-container">
                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <span class="product-label label-circle label-top">Top</span>
                                        <a href="product.php">
                                            <img src="assets/images/asus/asus-zenfone-10-xanh-la.jpg.webp" alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.php">Asus Zenfones 10</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $1,199.99
                                        </div><!-- End .product-price -->
                                        <div class="ratings-container">
                            ...
                            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                                ...
                                <div class="product product-2">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="productAppleWatchUltra.php">Apple Watch Ultra 2 GPS</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            <span class="new-price">$990.00</span>
                                            <span class="old-price">Was $1100.00</span>
                                        </div><!-- End .product-price -->
                                        <div class="ratings-container">
                                            <div class="ratings">
                                                <div class="ratings-val" style="width: 100%;"></div><!-- End .ratings-val -->
                                ...
                                <div class="product product-2">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product.php">Apple Watch SE 2</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $1,199.99
                                        </div><!-- End .product-price -->
                                        <div class="ratings-container">
                    ...
                    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                        ...
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product.php">Apple iPad Pro M2</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $999.99
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                        ...
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="productIphone15.php">iPhone 15</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $799.99
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <span class="product-label label-circle label-top">Top</span>
                                <a href="product.php">
                                    <img src="assets/images/asus/7_132.webp" alt="Product image" class="product-image">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product.php">Asus ROG Phone 7</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $899.99
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                    ...
                    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                        ...
                        <div class="product product-2">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="productAppleWatchUltra.php">Apple Watch Ultra 2</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    <span class="new-price">$990.00</span>
                                    <span class="old-price">Was $1100.00</span>
                                </div><!-- End .product-price -->
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <a href="product.php">
                                    <img src="assets/images/smartwatch/samsung-galaxy-watch5-tn-600x600.jpg" alt="Product image" class="product-image" width="100%">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product.php">Galaxy Watch 5 - 40mm</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $79.99
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <span class="product-label label-circle label-new">New</span>
                                <a href="product.php">
                                    <img src="assets/images/smartwatch/xiaomi-watch-2-pro-tb-600x600.jpg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options='{
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <span class="product-label label-circle label-top">Top</span>
                                <a href="product.php">
                                    <img src="assets/images/accessories/tai-nghe-bluetooth-airpods-pro-2.jpeg" alt="Product image" class="product-image">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product.php">Airpod Pro 2</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $1,199.99
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <span class="product-label label-circle label-top">Top</span>
                                <a href="product.php">
                                    <img src="assets/images/accessories/Sony WH-1000XM5.webp" alt="Product image" class="product-image">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product.php">Sony WH-1000XM5</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $899.99
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <span class="product-label label-circle label-top">Top</span>
                                <a href="product.php">
                                    <img src="assets/images/accessories/bluetooth-true-wireless-samsung-galaxy-buds2-pro-trang-040923-055806-600x600.jpg" alt="Product image" class="product-image">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product.php">Samsung Galaxy Buds 2 Pro</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $200.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <a href="product.php">
                                    <img src="assets/images/accessories/tai-nghe-khong-day-sony-wf-1000xm5_1.webp" alt="Product image" class="product-image">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product.php">Sony WF-1000XM5</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $250.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
                        ...
                        <div class="product product-2">
                            <figure class="product-media">
                                <span class="product-label label-circle label-new">New</span>
                                <a href="product.php">
                                    <img src="assets/images/accessories/apple_airpods_3_1.webp" alt="Product image" class="product-image">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product.php">Apple Airpod 3</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $130.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
    ...
    <!-- begin::footer -->
    <?php include("Layout/footer-call.php") ?>
    <!-- end::footer -->
            ...
            <div class="row no-gutters bg-white newsletter-popup-content">
                <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                    <div class="banner-content text-center">
                        <img src="assets/images/logo-icon.png" class="logo" alt="logo" width="60" height="15">
                        <h2 class="banner-title">get <span>25<light>%</light></span> off</h2>
                        <p>Subscribe to the Techolic newsletter to receive timely updates from your favorite products.</p>
                        <form action="#">
                ...
                <div class="col-xl-2-5col col-lg-5 ">
                    <img src="assets/images/phones.jpg" class="newsletter-img" alt="newsletter">
                </div>
            </div>
        </div>
    </div>
